...
import { DbConfig, CookieOptions } from "./interfaces";
...
export const PASSWORD_RESET_EXPIRATION =
  process.env.PASSWORD_RESET_EXPIRATION || "1h";
...
export const EMAIL_PASSWORD_FORGOT_PASSWORD =
  process.env.EMAIL_PASSWORD_FORGOT_PASSWORD;
